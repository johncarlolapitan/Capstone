...
class Model_requestorder extends CI_Model
{
	...
	public function update($id)
	{
		if($id) {
			...
			$rocode = 'ROCODE-'.strtoupper(substr(md5(uniqid(mt_rand(), true)), 0, 4));
			$data = array(
				'ro_code' => $rocode,
	    		'user_id' => $user_id,
	    	...
	    	for($x = 0; $x < $count_product; $x++) {
				...
				$user_id = $this->session->userdata('id');
						...
						$data1 = array(
							...
							'user_id' => $user_id,
							'action_made' => 'Updated [RO No = '.$order_data['ol_code'].'] in the Request Order',
						);
