        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('stockadjustment/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="date" class="form-control" id="exp_date" name="exp_date" autocomplete="off" value="<?php echo date('Y-m-d',$order_data['stockadjustment']['st_exp_date']) ?>" required><br>
                    </div>
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button id="addquanti" type="button" class="btn btn-success">Add Quantity</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Do you want to add product stock?</p>
      </div>
