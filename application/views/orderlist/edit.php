        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="ol_code" name="ol_code" disabled autocomplete="off" value="<?php echo $order_data['orderlist']['ol_code'] ?>"><br>
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a id="print" target="__blank" href="<?php echo base_url() . 'orderlist/printDiv/'.$order_data['orderlist']['id'] ?>" class="btn btn-default" >Print Receipt</a>
                ...
                <a id="go_back" href="<?php echo base_url('orderlist/') ?>" class="btn btn-danger">Go Back</a> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Do you want to update orderlist?</p>
      </div>
...
$('#btnsavec').on('click', function() {
  ...
  /* CHECKKKKKKKKPOINTTTTTTTTT */
    ...
    $("#manageorderlistSubMenu").addClass('active');
