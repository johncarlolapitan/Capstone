          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="main_category_1" name="main_category[]" required>
                      <option disabled selected hidden>--Select Main-Category--</option>
                    <?php foreach ($main_category as $k => $v): ?>
                      <option required value="<?php echo $v['id'] ?>"><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
               ...
               <div class="form-group">
                  ...
                  <select id="sub_category_1" class="form-control select_group" name="sub_category[]" onchange="getSubCategoryData(1)" required>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" pattern=".{3,}" required id="product_name" name="product_name" placeholder="Enter product name" autocomplete="off" value="<?php echo $this->input->post('product_name') ?>" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" min="1" required id="cost" name="cost" placeholder="Enter unit cost" autocomplete="off" onclick="getSRP(1)" onkeyup="getSRP(1)" value="<?php echo $this->input->post('cost') ?>" />
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="markup">Markup Value: <label style="color:red">*</label></label>
                      <input type="text" class="form-control" id="markup" name="markup" disabled autocomplete="off" placeholder="Markup Value">
                ...
                <div class="form-group">
                    <label for="srp">Selling Price: <label style="color:red">*</label></label>
                      <input type="text" class="form-control" id="srp" name="srp" disabled autocomplete="off" placeholder="Selling Price">
                 ...
                 <div class="form-group">
                  ...
                  <input type="number" class="form-control" min="1" required id="lead_time" name="lead_time" placeholder="Enter lead time" autocomplete="off" onclick="getROP(1)" onkeyup="getROP(1)" />
                </div>
                <div class="form-group">
                
                <div class="form-group">
                  <label for="daily_use">Daily Average Consume: <label style="color:red">*</label></label>
                  <input type="number" class="form-control" min="1" required id="daily_use" name="daily_use" placeholder="Enter daily average consume" autocomplete="off" onclick="getSafety(1)" onkeyup="getSafety(1)" />
                </div>

                <div class="form-group">
                    <label for="reorderpoint">Safety stock: <label style="color:red">*</label></label>
                      <input type="text" class="form-control" id="safety_stock" name="safety_stock" disabled autocomplete="off" placeholder="Safety Stock">
                      <input type="hidden" class="form-control" id="safety_stock_value" name="safety_stock_value" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="reorderpoint">Reoder Point: <label style="color:red">*</label></label>
                      <input type="text" class="form-control" id="reorderpoint" name="reorderpoint" disabled autocomplete="off" placeholder="Reoder Point">
                      <input type="hidden" class="form-control" id="reorderpoint_value" name="reorderpoint_value" autocomplete="off">
                </div>
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-success" id="testingmuna">Save Product </button>
...
$('#testingpindot').click(function() {
  ...
  function getSubCategoryData(row_id)
  {
    ...
    if(sub_category_id == "--Select Category--") {
      $("#markup").val("");
      $("#markup_value").val("");
