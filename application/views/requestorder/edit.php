    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('requestorder/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="ol_code" name="ol_code" disabled autocomplete="off" value="<?php echo $order_data['requestorder']['ol_code'] ?>"><br>
                    </div>
                  </div>
                 ...
                 <div class="form-group col-md-6 col-xs-12 pull pull-right">
                    ...
                    <div class="col-sm-6">
                      <select type="text" class="form-control" id="status" name="status">
                        ...
                        <option value="2">Not Requested</option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a id="print" target="__blank" href="<?php echo base_url() . 'requestorder/printDiv/'.$order_data['requestorder']['id'] ?>" class="btn btn-default" >Print Receipt</a>
                ...
                <a id="go_back" href="<?php echo base_url('requestorder/') ?>" class="btn btn-danger">Go Back</a> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Update Request Order</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Do you want to update request order?</p>
      </div>
...
$(document).ready(function() {
    ...
    $("#requestorderlistMainNav").addClass('active');
    $("#managerequestorderSubMenu").addClass('active');
