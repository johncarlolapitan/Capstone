        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
                ...
                $data1 = array(
                    ...
                    'user_id' => $user_id,
                    'action_made' => 'Created ['.$this->input->post('group_name').'] in the Group list',
                );
			...
			if ($this->form_validation->run() == TRUE) {
	        	...
	        	if($update == true) {
					...
					$data1 = array(
						'date_time' => strtotime(date('Y-m-d h:i:s a')),
						'user_id' => $user_id,
						'action_made' => 'Updated ['.$this->input->post('group_name').'] in the Group list',
					);
				...
				if($check == true) {
					...
					if($delete == true) {
						...
						$data1 = array(
							'date_time' => strtotime(date('Y-m-d h:i:s a')),
							'user_id' => $user_id,
							'action_made' => 'Deleted [id = '.$id.'] in the Group list',
						);
