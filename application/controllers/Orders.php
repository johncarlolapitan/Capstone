...
class Orders extends Admin_Controller 
{
	...
	*/
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
			...
			$this->data['products1'] = $this->model_products->getActiveProductData1(); 

			$this->data['discount'] = $this->model_discount->getActiveDiscount();   
	...
	*/
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
			...
			$this->data['payment'] = $this->model_payment->getActivePayment();   
			$this->data['id'] = $id;
	...
	*/
	public function remove()
	{
		...
		$discinfo = $this->model_orders->getOrdersData($order_id);
        $response = array();
        if($order_id) {
            ...
            if($delete == true) {
				...
				$user_id = $this->session->userdata('id');
						...
						$data1 = array(
							...
							'user_id' => $user_id,
							'action_made' => 'Deleted [Bill No = '.$discinfo['bill_no'].'] in the Order list',
				);
 ...
 <div class="col-sm-4 invoice-col">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
					...
					<b>Cashier: </b> '.$user_info['firstname'].' '.$user_info['lastname'].'<br><br>
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
			    ...
			    <div class="row">
			      ...
			      <div class="col-xs-6 pull pull-right">
			        ...
			        <div class="table-responsive">
			          <table class="table">
			            <tr>
			              <th style="width:50%">Gross Amount '.$this->currency_code .':</th>
						...
						<tr>
			              <th>Discount Amount '.$this->currency_code .': </th>
			              <td>'.$discount.'</td>
			            </tr>
			            <tr>
			              <th>Net Amount '.$this->currency_code .':</th>
			              <td>'.$this->currency_code . ' ' .$order_data['net_amount'].'</td>
			            </tr>
						<tr>
			              <th>Cash Tendered '.$this->currency_code .':</th>
			              <td>'.$this->currency_code . ' ' .$order_data['cash_tendered'].'</td>
			            </tr>
						<tr>
			              <th>Change '.$this->currency_code .':</th>
			              <td>'.$this->currency_code . ' ' .$order_data['total_change'].'</td>
			            </tr>
			            <tr>
			              <th>Paid Status:</th>
			              <td>'.$paid_status.'</td>
...
<hr>
<div style="text-align: center;"> <p > MARAMING SALAMAT PO! <br> </p><p> WE HOPE TO SEE YOU AGAIN SOON.</p></div>
			    <!-- /.row -->
			  </section>
			  <!-- /.content -->
			</div>
